"""
Chess domain: Get position material info from board module
"""
...
def get_position_material_info_from_board(board: Board) -> PositionMaterialInfo:
    """
    Get the material information of a chess position from a given chess board.
