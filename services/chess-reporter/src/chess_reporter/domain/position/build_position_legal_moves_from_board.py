"""
Chess domain: Build position legal moves from board module
"""
...
def build_position_legal_moves_from_board(board: Board) -> PositionLegalMoves:
    """
    Build the legal moves of a chess position from a given chess board.
