"""
Chess domain: Build position outcome from board module
"""
...
def build_position_game_outcome_from_board(board: Board) -> GameOutcome:
    """
    Build the position game outcome from a given chess board position.
