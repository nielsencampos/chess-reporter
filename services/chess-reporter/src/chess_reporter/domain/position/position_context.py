...
from .build_position_game_outcome_from_board import build_position_game_outcome_from_board
from .build_position_legal_moves_from_board import build_position_legal_moves_from_board
from .build_position_material_info_from_board import build_position_material_info_from_board
...
class PositionContext(BaseModel):
    ...
    def game_outcome(self) -> GameOutcome:
        ...
        return build_position_game_outcome_from_board(self.board)
    ...
    def material_info(self) -> PositionMaterialInfo:
        ...
        """
        return build_position_material_info_from_board(self.board)
    ...
    def legal_moves(self) -> PositionLegalMoves:
        ...
        """
        return build_position_legal_moves_from_board(self.board)
